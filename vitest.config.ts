...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      include: ['server/lib/jsonlSerializer.ts', 'server/lib/lsmCompactor.ts', 'server/lib/jsonlStream.ts', 'server/lib/mapReduceViews.ts', 'server/lib/materializedViews.ts'],
      // Coverage thresholds
      thresholds: {
        lines: 80,
        functions: 80,
