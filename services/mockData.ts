import { Entity, EntityRole, EntityType, Account, AccountType, DCFlag, TaxModule, Contractor, ComplianceFiling, WalletCredential, BSORole, BSOSubmission, IRSAPICredential, Employee, PayrollRun, IRMDocument } from '../types';
...
export const SEED_ACCOUNTS: Account[] = [
  // Trust Accounts
  { id: "AC-101", entityId: "ENT-001", code: "101000", name: "Operating Cash", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 125000.00 },
  { id: "AC-102", entityId: "ENT-001", code: "102000", name: "Tax Payment Clearing", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 0 },
  { id: "AC-103", entityId: "ENT-001", code: "103000", name: "Remittance Suspense", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 0 },
  { id: "AC-140", entityId: "ENT-001", code: "140000", name: "Prepaid Taxes", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 0 },
  { id: "AC-150", entityId: "ENT-001", code: "150000", name: "Investment – Operating LLC", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 25000.00 },
  { id: "AC-301", entityId: "ENT-001", code: "301000", name: "Trust Corpus", type: AccountType.EQUITY, normalBalance: DCFlag.Credit, balance: 150000.00 },
  
  // LLC Accounts
  { id: "AC-L101", entityId: "ENT-002", code: "101000", name: "Operating Cash – LLC", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 42000.50 },
  { id: "AC-L510", entityId: "ENT-002", code: "510100", name: "Contractor Labor Expense", type: AccountType.EXPENSE, normalBalance: DCFlag.Debit, balance: 0 },
  { id: "AC-L210", entityId: "ENT-002", code: "210100", name: "Contractor Payable", type: AccountType.LIABILITY, normalBalance: DCFlag.Credit, balance: 0 },
  { id: "AC-L520", entityId: "ENT-002", code: "520100", name: "Materials Expense", type: AccountType.EXPENSE, normalBalance: DCFlag.Debit, balance: 0 },
  { id: "AC-L521", entityId: "ENT-002", code: "520110", name: "Materials Sales Tax Expense", type: AccountType.EXPENSE, normalBalance: DCFlag.Debit, balance: 0 },
  { id: "AC-L300", entityId: "ENT-002", code: "300000", name: "Member Capital – Trust", type: AccountType.EQUITY, normalBalance: DCFlag.Credit, balance: 25000.00 },
  // Payroll specific accounts
  { id: "AC-L530", entityId: "ENT-002", code: "530000", name: "Salaries & Wages", type: AccountType.EXPENSE, normalBalance: DCFlag.Debit, balance: 0 },
  { id: "AC-L531", entityId: "ENT-002", code: "530100", name: "Payroll Tax Expense", type: AccountType.EXPENSE, normalBalance: DCFlag.Debit, balance: 0 },
  { id: "AC-L220", entityId: "ENT-002", code: "220000", name: "Payroll Liabilities (941/State)", type: AccountType.LIABILITY, normalBalance: DCFlag.Credit, balance: 0 },
  // Enforcement Accounts
  { id: "AC-L290", entityId: "ENT-002", code: "290000", name: "Garnishment Payable (Levy)", type: AccountType.LIABILITY, normalBalance: DCFlag.Credit, balance: 0 },
];
...
export const SEED_FILINGS: ComplianceFiling[] = [
  { id: "FIL-001", entityId: "ENT-001", formType: "56", status: "Filed", filingDate: "2024-01-15", notes: "Trustee Appointment" },
  { id: "FIL-002", entityId: "ENT-001", formType: "2848", status: "Drafted", notes: "Auth for CPA" },
  { id: "FIL-003", entityId: "ENT-002", formType: "56", status: "Not Started", notes: "Member Managed" },
  // Unpostable Example
  { id: "FIL-004", entityId: "ENT-001", formType: "1041", status: "Unpostable", filingDate: "2024-04-15", notes: "Entity Name Mismatch - Suspense" },
];
