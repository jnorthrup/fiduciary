...
export const JIM_ACCOUNTS: Account[] = [
    { id: "AC-101", entityId: "ENT-ROOT", code: "101000", name: "Master Treasury Account", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 1250000.00, vendor: 'BOFA', _version: GENESIS_HASH },
    ...
    { id: "AC-102", entityId: "ENT-AAA-TRUST", code: "101000", name: "Operating Cash", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 485000.00, vendor: 'CHASE', _version: GENESIS_HASH }, // Reduced by 15k for payment
    ...
    { id: "AC-103", entityId: "ENT-VERSA-LLC", code: "101000", name: "Business Checking", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 285400.00, vendor: 'BASELANE', _version: GENESIS_HASH },
    { id: "AC-104", entityId: "ENT-FARMS-LAND", code: "101000", name: "Land Trust Reserves", type: AccountType.ASSET, normalBalance: DCFlag.Debit, balance: 45000.00, vendor: 'WELLS_FARGO', _version: GENESIS_HASH },
    // Versatile Accounts
