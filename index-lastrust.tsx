...
// Force "Lastrust" mode by setting a flag or using a specific prop if App supported it.
// For now, App detects auth state. We just need to ensure the environment is right.
// We can set a global flag or context to indicate this is the "Lastrust" hemisphere.
window.HEMISPHERE = 'LASTRUST';
