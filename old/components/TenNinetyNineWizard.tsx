    ...
    useEffect(() => {
        ...
        if (contractor) {
            setRecipientData(prev => ({
                ...
                address1: contractor.streetAddress || '123 Business Rd', // Fallback to mock if not set
                city: contractor.city || 'Commerce City',
                state: contractor.state || 'WY',
                zip: contractor.zipCode || '82001'
            }));
        }
        ...
        <div className="bg-white border-2 border-red-600 p-6 font-mono text-xs shadow-xl relative w-full max-w-2xl mx-auto">
            ...
            <div className="flex justify-between items-start border-b-2 border-black pb-2 mb-4">
                <div className="w-1/2 border-r-2 border-black pr-4">
                    ...
                    <div>{entity.streetAddress || '1234 Sovereign Way, Suite 100'}</div>
                    <div>{entity.city || 'Cheyenne'}, {entity.state || 'WY'} {entity.zipCode || '82001'}</div>
                    <div>{entity.phone || '(307) 555-0199'}</div>
                </div>
