      ...
      if (['Power of Attorney', 'Fiduciary Notice'].includes(docType)) {
          ...
          try {
              ...
              if (docType === 'Power of Attorney') {
                  prompt = `Generate a Power of Attorney and Declaration of Representative (similar to IRS Form 2848).
                  Taxpayer: ${entity.name}, EIN: ${entity.einLast4 ? 'XX-XXX'+entity.einLast4 : 'PENDING'}.
                  Representative: ${repName}, Address: ${repAddress}, CAF: ${cafNo}.
                  Matters: ${authMatters}. Years: ${taxYears}.
                  Include standard acts authorized (receive info, sign returns).`;
              } else {
                  prompt = `Generate a Notice of Fiduciary Relationship (similar to IRS Form 56).
                  Fiduciary: ${entity.name} (acting as ${fiduciaryTitle}).
                  Authority Evidence: Trust Indenture/Letters Testamentary dated ${evidenceDate}.
                  Address: [Insert Entity Address].
                  Powers: Full authority to perform all acts required of taxpayer.`;
              }
