/**
 * Unified Entry Point
 * Shows Google OAuth login (via Firebase Auth), then dual-entry splash to select skin
 */
            ...
            <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex flex-col items-center justify-center p-6">
                <div className="text-center max-w-md">
                    ...
                    <button
                        ...
                        className="bg-white text-slate-700 px-6 py-3 rounded-lg font-semibold flex items-center justify-center gap-3 w-full hover:bg-slate-50 transition-colors"
                    >
